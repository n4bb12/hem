...
/**
 * Run by the 'npm restart' command. Note: 'npm restart' will
...
export interface CoreProperties {
  ...
  version?: string
  /**
   * This helps people discover your package, as it's listed
   * in 'npm search'.
   */
  description?: string
  /**
  ...
  bugs?:
    ...
    | string
  /**
   * You should specify a license for your package so that people
  ...
  maintainers?: Person[]
  /**
   * The 'files' field is an array of files to include in your
   * project. If you name a folder in the array, then it will
   * also include the files inside that folder.
   */
  files?: string[]
  /**
  ...
  /**
   * Specify either a single file or an array of filenames to
   * put in place for the man program to find.
   */
  man?: string[]
  directories?: {
    /**
     * If you specify a 'bin' directory, then all the files
     * in that folder will be used as the 'bin' hash.
     */
    bin?: string
    /**
     * Put markdown files in here. Eventually, these will be
     * displayed nicely, maybe, someday.
     */
    doc?: string
    /**
     * Put example scripts in here. Someday, it might be exposed
     * in some clever way.
     */
    example?: string
    /**
     * Tell people where the bulk of your library is. Nothing
     * special is done with the lib folder in any way, but it's
     * useful meta info.
     */
    lib?: string
    /**
  ...
  /**
   * Specify the place where your code lives. This is helpful
   ...
   * that are run at various times in the lifecycle of your
   * package. The key is the lifecycle event, and the value
   * is the command to run at that point.
   */
  scripts?: {
    /**
  ...
  /**
   * You can specify which operating systems your module will
   * run on
   */
  os?: string[]
  /**
   * If your code only runs on certain cpu architectures, you
   * can specify which ones.
   */
  cpu?: string[]
  /**
   * If your package is primarily a command-line application
   * that should be installed globally, then set this value
  ...
  module?: string
  /**
   * A module ID with untranspiled code that is the primary
...
/**
 * Dependencies are specified with a simple hash of package
 * name to version range. The version range is a string which
 * has one or more space-separated descriptors. Dependencies
